...
questions in review threads and PR conversation, can re-review pushed commits
as a scoped delta once a review exists (opt-in), and takes its review doctrine
...
the finding covers changes materially later, it can come back as open.
