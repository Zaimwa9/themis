...
SKILL_PATH = ".claude/skills/pr-review/SKILL.md"
...
Read `{SKILL_PATH}` in this checkout and follow it: it contains the review doctrine
and a map of this codebase so you do not need to explore. Read the diff first and
open only the files it implicates. If the skill file is missing, still review using
the contract below.
...
def build_discussion_prompt(
    *, question: str, kind: Literal["thread", "conversation"], thread_context: str
    ...
    return f"""\
You are the bookia review bot. Someone commented on {location} of a pull
