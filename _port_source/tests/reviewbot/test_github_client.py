...
from reviewbot.github.client import SUMMARY_MARKER, GitHubClient, GitHubGraphQLError
        ...
        return httpx.Response(200, json={"data": {"repository": {"pullRequest": {
            "reviewThreads": {
                ...
                "nodes": [{"id": "T_1", "isResolved": False, "path": "a.py", "line": 3,
                           "resolvedBy": None,
                           "comments": {"nodes": [{"author": {"login": "bookia-reviewer"},
...
async def test_list_review_threads__root_outside_tail__merges_root_first_no_dupes():
    root = {"author": {"login": "bookia-reviewer"}, "body": "A",
